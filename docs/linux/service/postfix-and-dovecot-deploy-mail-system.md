 ...
 * @version: 
 * @Descripttion: Postfix 与 Dovecot 部署邮件系统
 -->
...
![电子邮件的传输过程](https://cdn.jsdelivr.net/gh/jangrui/images@main//2024/03/18/20240318175629.png)

## 部署邮件系统

一个最基础的电子邮件系统肯定要能提供发件服务和收件服务，为此需要使用基于 SMTP 协议的 Postfix 服务程序提供发件服务功能，并使用基于 POP3 协议的 Dovecot 服务程序提供收件服务功能。电子邮件系统的工作流程如图所示。

![电子邮件系统的工作流程](https://cdn.jsdelivr.net/gh/jangrui/images@main//2024/03/18/20240318175618.png)
