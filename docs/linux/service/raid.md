 ...
 * @LastEditors: jangrui
 * @LastEditTime: 2019-09-10 14:00:13
 * @version: 
 * @Descripttion: RAID 磁盘冗余阵列
 -->
...
![RAID 0](https://cdn.jsdelivr.net/gh/jangrui/images@main//2024/03/18/20240318175655.png)
...
![RAID 1](https://cdn.jsdelivr.net/gh/jangrui/images@main//2024/03/18/20240318175708.png)

RAID 1 技术虽然十分注重数据的安全性，但是因为是在多块硬盘设备中写入了相同的数据，因此硬盘设备的利用率得以下降，从理论上来说，硬盘空间的真实可用率只有50%，由三块硬盘设备组成的 RAID 1 磁盘阵列的可用率只有 33% 左右，以此类推。而且，由于需要把数据同时写入到两块以上的硬盘设备，这无疑也在一定程度上增大了系统计算功能的负载。
...
![RAID 5](https://cdn.jsdelivr.net/gh/jangrui/images@main//2024/03/18/20240318175721.png)
...
![RAID 10](https://cdn.jsdelivr.net/gh/jangrui/images@main//2024/03/18/20240318175733.png)
