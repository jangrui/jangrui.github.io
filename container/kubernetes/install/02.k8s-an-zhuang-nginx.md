...
> 在浏览器中访问 访问地址格式为 MasterIP:NodePort, NodePort 为kubectl get service/nginx-servic 后 88:80/TCP中 80这个端口；本次为[http://任意节点ip:80/](http://任意节点ip:80/)
